	...
	<form:form action="changePassword" id="member_change" modelAttribute="memberVO">
		...
		<ul>
			<li>
				...
				<form:password path="now_passwd" cssClass="form-input"/>
				<form:errors path="now_passwd" cssClass="error-color"/>
			</li>		
			<li>		
				<form:label path="passwd">비밀번호</form:label>
				<form:password path="passwd" cssClass="form-input"/>
					...
					$(function(){
						$('#reload_btn').click(function(){
							$.ajax({
								...
								type:'get',
								success:function(){
									$('#captcha_div').load(location.href+' #captcha_div');/* 반드시 공백 넣어줘야 특정 공간으로 인식함 */
								},
								error:function(){
									alert('네트워크 오류 발생');	
								}
