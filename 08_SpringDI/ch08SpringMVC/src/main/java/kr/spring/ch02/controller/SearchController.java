...
public class SearchController {
	/*
	 * @ReuqestParam 어노테이션은 HTTP 요청 파라미터를 메서드의
	 * 파라미터로 전달
	 * [형식]
	 * 1. @RequestParam(요청파라미터네임) 메서드의 인자(파라미터)
	 *    ex) (@RequestParam("queryA" String queryB)
	 * 
	 ...
	 *    ex) (@RequestParam(required=false) String query)
	 * 
	...
	public ModelAndView searchExternal(String query, @RequestParam(defaultValue="0")int pageNumber) {
